...
from .models import Venta,EstadoPedido,VentaDetalle,DatosFacturacion
...
class DatosFacturacionInline(StackedInline):
    ...
    extra = 0
    tab = True
    readonly_fields = ('nombre','apellido','razon_social','dni_cuit','condicion_iva','provincia','localidad','direccion','codigo_postal')
...
class VentaAdmin(ModelAdmin):
    ...
    inlines = [VentaDetalleInline,DatosFacturacionInline, EstadoPedidoInline,TicketDePagoInline]

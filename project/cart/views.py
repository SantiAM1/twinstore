...
from .serializers import CalcularPedidoSerializer
import re
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            if data['metodo_pago'] == 'mercado_pago':
                recargo = round(float(data['total_precio']) * 0.0761,2)
            else:
                recargo = 0
            total_compra = float(data['total_precio']) + recargo
            ...
            preference = preference_mp(request,total_compra,carrito_id,dni_cuit,ident_type,email,nombre,apellido,codigo_postal,calle_nombre,calle_altura)
            return Response({
                'total': total_compra,
                'adicional': recargo,
...
def preference_mp(request, numero, carrito_id, dni_cuit, ident_type, email,nombre,apellido,codigo_postal,calle_nombre,calle_altura):
